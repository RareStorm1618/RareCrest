...
**Work Order:** WO-3 — Implement tenancy keys and soft-delete windows in the data model
...
Files reviewed: packages/db/src/client.ts, packages/db/migrations/001_core_schema.sql
