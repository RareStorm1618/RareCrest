...
**Work Order:** WO-64 — Implement MorningBriefGenerator and AttentionQueueService (API Server)
...
Files reviewed: packages/command-surface/src/index.ts, apps/api/src/routes/command-routes.ts
