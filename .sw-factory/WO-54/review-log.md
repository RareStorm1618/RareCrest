...
Files reviewed: packages/migration-workspace/src/transition-budget.ts, packages/migration-workspace/src/kill-switches.ts, apps/api/src/routes/migration-workspace-routes.ts
